...
Current state: SPEC-007 completada, validada y cerrada. Bug vialAvailable corregido. BUG-002/BUG-003 → RESUELTOS con validación visual y experimental. H012: distancia vial +54.3% sobre geodésico (339→523 km, +184 km). D010 registrado: versionado acumulativo de publicaciones. 12 hallazgos (H001–H012), 15 preguntas (PI-001—PI-015), 10 decisiones (D001–D010), 5 contribuciones (C001–C005), 6 validaciones (V001–V006), 3 bugs cerrados. SPEC-008 en planeación (comparación simultánea, filtrado de rutas).
